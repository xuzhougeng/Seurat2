# News
All notable changes to Seurat2 will be documented in this file.
...
- SetAssayData ensures cell order is the same between assay objects and the Seurat2 object
