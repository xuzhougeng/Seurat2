...
nbt.test <- new("seurat2", raw.data = nbt.small)

nbt.test <- CreateSeurat2Object(raw.data = nbt.small,
...
test_that("object initialization creates seurat2 object", {
  expect_is(nbt.test, "seurat2")
})
