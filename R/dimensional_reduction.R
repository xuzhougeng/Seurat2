...
#'
#' @return Returns Seurat2 object with the PCA calculation stored in
#' object@@dr$pca.
#'
#' @importFrom irlba irlba
#'
...
#'
#' @return Returns Seurat2 object with an ICA calculation stored in
#' object@@dr$ica
#'
#' @export
#'
...
#'
#' @return Returns a Seurat2 object with a tSNE embedding in
...
#'
#' @return Returns Seurat2 object with the projected values in
...
#' @param do.center Center the dataset prior to projection (should be set to TRUE)
#'
#' @return Returns Seurat2 object with the projected PCA values in
...
#'
#' @param object.list List of Seurat2 objects
...
#'
#' @return Returns a combined Seurat2 object with the CCA stored in the @@dr$cca slot.
#'
...
RunMultiCCA <- function(
  ...
  mat.list <- list()
  if(class(object.list[[1]]) == "seurat2"){
    if (missing(x = genes.use)) {
      genes.use <- c()
    ...
    stop("input data not Seurat2 objects")
  }
  ...
  for(i in 2:length(object.list)){
    combined.object <- MergeSeurat2(object1 = combined.object, object2 = object.list[[i]], do.scale = F, do.center = F, do.normalize = F)
  }
...
#'
#' @return Returns a Seurat2 object with a diffusion map
#'
...
#'
#' @return Returns a Seurat2 object containing a PHATE representation
#'
#' @importFrom utils installed.packages
#' @export
#'
...
#'
#' @return Returns a Seurat2 object containing a UMAP representation
#'
