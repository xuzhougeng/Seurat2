...
globalVariables(names = 'avg_logFC', package = 'Seurat2', add = TRUE)
...
#' recommended, as Seurat2 pre-filters genes using the arguments above, reducing
...
globalVariables(names = c('myAUC', 'p_val'), package = 'Seurat2', add = TRUE)
#' Find all markers for a node
#'
#' This function finds markers for all splits at or below the specified node
#'
#' @param object Seurat2 object. Must have object@@cluster.tree slot filled. Use BuildClusterTree() if not.
...
#' @param test.use Denotes which test to use. Seurat2 currently implements
...
globalVariables(names = 'min.cells', package = 'Seurat2', add = TRUE)
