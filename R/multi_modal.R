...
#'
#' @return Seurat2 object with updated slot
#'
...
#'
#' @param object Seurat2 object. Assumes that the hash tag oligo (HTO) data has been added and normalized.
...
#' 
#' @return The Seurat2 object with the following demultiplexed information stored in the meta data:
...
#'
#' @param object Seurat2 object. Assumes that the hash tag oligo (HTO) data has been added and normalized, and demultiplexing has been run with HTODemux().
