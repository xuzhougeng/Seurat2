...
#'
#' Currently, Seurat2 assumes that the tissue of interest has an 8x8 bin
...
#'
#' @return Seurat2 object, where mapping probabilities for each bin are stored
...
#'
#' @return A Seurat2 object, where the posterior of each cell being in the 'on'
