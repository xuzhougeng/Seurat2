...
#'
#' @return Returns a Seurat2 object with module scores added to object@meta.data
#'
...
#'
#' @return A Seurat2 object with the following columns added to object@meta.data: S.Score, G2M.Score, and Phase
#'
